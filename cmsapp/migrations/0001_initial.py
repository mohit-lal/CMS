# Generated by Django 2.1.5 on 2019-02-18 11:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(max_length=200)),
                ('email', models.EmailField(max_length=254)),
                ('image', models.ImageField(blank=True, default='/default.jpg', null=True, upload_to='consultant/')),
                ('about', models.TextField(blank=True, null=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='/default.jpg', null=True, upload_to='countries/')),
            ],
        ),
        migrations.CreateModel(
            name='Course',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='/default.jpg', null=True, upload_to='lead/')),
                ('about', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=254)),
                ('about', models.TextField(blank=True, null=True)),
                ('image', models.ImageField(blank=True, default='/default.jpg', null=True, upload_to='receptionist/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='/default.jpg', null=True, upload_to='student/')),
                ('about', models.TextField(blank=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=100)),
                ('study_file', models.FileField(upload_to='study_file/')),
                ('language_course', models.ForeignKey(max_length=150, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='language_course', to='cmsapp.LanguageCourse')),
            ],
        ),
        migrations.CreateModel(
            name='Task',
            fields=[
                ...
                ('priority', models.CharField(choices=[('Urgent', 'Urgent'), ('High', 'High'), ('Low', 'Low'), ('Medium', 'Medium')], default='Medium', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='/default.jpg', null=True, upload_to='teacher/')),
                ('about', models.TextField(blank=True, null=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relation', models.CharField(blank=True, choices=[('Partnered', 'Partnered'), ('Non partnered', 'Non partnered')], max_length=100, null=True)),
                ('requirements', models.TextField(blank=True, null=True)),
                ('contact_person', models.TextField(blank=True, null=True)),
                ('term', models.CharField(blank=True, choices=[('fall', 'fall'), ('spring', 'spring'), ('summer', 'summer')], max_length=120, null=True)),
                ('phone', models.CharField(max_length=10)),
                ('email', models.EmailField(blank=True, max_length=254, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('about', models.TextField(blank=True, null=True)),
                ('image', models.ImageField(blank=True, default='/default.jpg', null=True, upload_to='visitor/')),
            ],
        ),
        migrations.AddField(
            model_name='student',
